  ...
  return (
    <section className="relative font-geist-sans h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div
          className={`max-w-4xl mx-auto text-center transition-all duration-1000 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
        >
          <MovingButton
            containerClassName="w-auto h-1/4 mb-6 max-w-[300px] mx-auto"
            borderRadius="1.75rem"
            className="text-purple-300 bg-gradient-to-r from-purple-400/10 to-purple-400/20 w-auto px-6 py-2 text-sm inline-flex items-center justify-center rounded-full backdrop-blur-sm border border-purple-400/10 hover:scale-105 transform transition-all"
          >
          ...
          {/* Animated Heading */}
          <motion.h1
            className="text-4xl md:text-6xl lg:text-7xl font-geist-sans font-bold text-white mb-8 tracking-tight"
            initial="hidden"
            animate="show"
          ...
          <motion.p
            ...
            variants={FADE_DOWN_ANIMATION_VARIANTS}
          >
            Affordable Product Development for Manufacturing Companies.
